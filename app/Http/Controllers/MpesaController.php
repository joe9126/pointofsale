...
class MpesaController extends Controller
{
        ...
        public function customerMpesaSTKPush()
    {
        ...
        $curl_post_data = [
            ...
            'Amount' => 5,
            'PartyA' => 254702907485, // replace this with your phone number
            'PartyB' => 174379,
            'PhoneNumber' => 254702907485, // replace this with your phone number
    ...
    public function generateAccessToken(){
        $consumer_key="lg3GTpnFoWrzoz9YGxExnbCv2TZB0gYv";
        $consumer_secret="hks05Mtm5FwHqE2W";
...
/**
    ...
    public function mpesaRegisterUrls()
    {
        ...
        curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode(array(
            ...
            'ConfirmationURL' => "https://7529ca71b24f.ngrok.io/v1/hlab/transaction/confirmation",
            'ValidationURL' => "https://7529ca71b24f.ngrok.io/v1/hlab/validation"
        )));
        $curl_response = curl_exec($curl);
        echo $curl_response;
    }
