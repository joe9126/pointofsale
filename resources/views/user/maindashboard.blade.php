...
@section('content')
	...
	<div class="container-fluid">
		<div class="row" style="margin-top:5px;">
			<div class="col-lg-2 logospan" style="border-right:1px solid  #dddddf; background-image:url('{{asset('assets/images/primepos.png')}}');
      background-size:180px 80px; background-position:center center;">
			...
			<div class="col-lg-10 searchbar" style="border-top:1px solid grey; box-shadow:  0 5px 15px -7px gray; height:50px;">
				<input class="search-input" type="text" placeholder="Search here" style="background:url('{{url('assets/images/search_icn.png')}}'); background-size: 20px 20px;
            		 background-position: 5px 5px;  text-indent: 30px; background-repeat: no-repeat;">
				<div class="userprofileicon" style="background-image:url('{{asset('assets/images/usericon.jpeg')}}')" ></div>
		...
		<div class="row bg-light" >
			<div class="col-lg-2 sidemenubardiv" >
				...
				<div class="row">
					<div class="guideimage" style="background-image:url('{{asset('assets/images/guideimage.jpeg')}}')"></div>
				</div>
			 </div>
